...
// Binding key for denne consumer: "tour.*" matcher routing keys der er "tour." + præcis ét ord
// altså både "tour.booked" og "tour.cancelled". Derfor fanger Back-Office begge slags beskeder.
...
// ContainerId er et AMQP koncept, der identificerer denne klient i broker management-UI - så den hedder "tour-backoffice-consumer"
...
try
{
    ...
    // Binder queue til exchange med routingKey "tour.*" så alt der indeholder tour. vil blive leveret til denne queue.
